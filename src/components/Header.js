...
import GameIconWrapper from "../iconPaths";
        ...
        return (
            ...
            >
                ...
                <List>
                    ...
                    <Divider/>
                    <React.Fragment>
                        <Index onClick={() => this.props.onclick(allSkills)} key={"Index"}/>
                        <Glossary onClick={() => this.props.renderCategory(allSkills)} key={'Glossary'}/>
                    </React.Fragment>
                </List>
            </Drawer>
        );
